...
namespace lpzrobots {
    ...
    /// configuration object for the Sphererobot3MassesMod robot.
    typedef struct {
    public:
        double diameter;
        double spheremass;
        ...
        bool irInverseValue;    ///< set 0 as 'no obstacles' and 1 for 'obstacles'
...
*/
    class Sphererobot3MassesMod : public OdeRobot {
    public:
        /// enum for the objects of the robot
        enum parts {
            Base, Pendular1, Pendular2, Pendular3, Last
        };
    ...
    protected:
        ...
        Sphererobot3MassesModConf conf;
    ...
    public:
         ...
         *constructor
         **/
        Sphererobot3MassesMod(const OdeHandle &odeHandle, const OsgHandle &osgHandle,
                              const Sphererobot3MassesModConf &conf, const std::string &name,
    ...
    public:
        virtual ~Sphererobot3MassesMod();


        /// default configuration
        static Sphererobot3MassesModConf getDefaultConf() {
            Sphererobot3MassesModConf c;
            c.diameter = 1;
            c.spheremass = .3;// 0.1
            c.pendularmass = 1.0;
